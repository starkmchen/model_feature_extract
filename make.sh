...
rm -r proto
cp -r ../proto .
./protoc -I=. --cpp_out=proto/ proto/*.proto
...
g++ -o libpyfeature_extract.so --shared -fPIC -I/usr/include/python2.7 -I/mnt/chenmin/ad_feature -I/mnt/chenmin/ad_feature/proto -I/mnt/chenmin/lib/include ads_feature.cpp hash.cpp pybind.cpp ../proto/*.cc -L/mnt/chenmin/lib/lib/ -Wl,-rpath=lib -lprotobuf --std=c++11
